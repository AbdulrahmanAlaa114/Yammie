...
private final class EnumeratedSink<Element, Observer: ObserverType>: Sink<Observer>,
ObserverType where Observer.Element == (index: Int, element: Element) {
    var index = 0
...
private final class Enumerated<Element>: Producer<(index: Int, element: Element)> {
    ...
    where Observer.Element == (index: Int, element: Element) {
