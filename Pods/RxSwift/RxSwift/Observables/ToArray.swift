...
private final class ToArraySink<SourceType, Observer: ObserverType>: Sink<Observer>,
...
private final class ToArray<SourceType>: Producer<[SourceType]> {
    ...
    override func run<Observer: ObserverType>(
        _ observer: Observer,
        cancel: Cancelable
    ) -> (sink: Disposable, subscription: Disposable) where Observer.Element == [SourceType] {
