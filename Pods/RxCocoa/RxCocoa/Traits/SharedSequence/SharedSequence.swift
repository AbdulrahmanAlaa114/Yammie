...
ObservableConvertibleType {
     ...
     */
    public static func createUnsafe<Source: ObservableType>(source: Source)
    -> SharedSequence<SharingStrategy, Source.Element> {
...
public extension SharedSequence {
    ...
    /**
      ...
      - returns: The observable sequence whose elements are pulled from the given enumerable sequence.
     */
    static func from<Sequence: Swift.Sequence>(_ sequence: Sequence) -> SharedSequence<SharingStrategy, Element>
