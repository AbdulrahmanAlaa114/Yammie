    ...
    SynchronizedOnType where Observer.Element == Observable<Element>
{
    ...
    init(parent: Parent, observer: Observer, cancel: Cancelable) {
        ...
        self.refCountDisposable = RefCountDisposable(disposable: groupDisposable)
    ...
    func createTimer(_ windowId: Int) {
        ...
        let scheduledRelative = parent.scheduler
            .scheduleRelative(windowId, dueTime: parent.timeSpan) { previousWindowId in
...
private final class WindowTimeCount<Element>: Producer<Observable<Element>> {
    ...
    where Observer.Element == Observable<Element> {
