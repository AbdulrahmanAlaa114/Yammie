...
public extension InfallibleType {
     ...
     */
    func concat<Source: ObservableConvertibleType>(_ second: Source) -> Infallible<Element>
...
public extension InfallibleType {
     ...
     */
    static func merge<Collection: Swift.Collection>(_ sources: Collection) -> Infallible<Element>
    where Collection.Element == Infallible<Element> {
        Infallible(Observable.concat(sources.map { $0.asObservable() }))
    }
...
public extension InfallibleType {
     ...
     */
    func withLatestFrom<Source: InfallibleType, ResultType>(
        _ second: Source,
        resultSelector: @escaping (Element, Source.Element) throws -> ResultType
    ) -> Infallible<ResultType> {
