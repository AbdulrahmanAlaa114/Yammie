...
final class CombineLatestSink2_<E1, E2, Observer: ObserverType>: CombineLatestSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer1 = CombineLatestObserver(
            lock: lock,
            parent: self,
            index: 0,
            setLatestValue: { (e: E1) in self.latestElement1 = e },
            this: subscription1
        )
        let observer2 = CombineLatestObserver(
            lock: lock,
            parent: self,
            index: 1,
            setLatestValue: { (e: E2) in self.latestElement2 = e },
            this: subscription2
        )
...
final class CombineLatestSink3_<E1, E2, E3, Observer: ObserverType>: CombineLatestSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer3 = CombineLatestObserver(
            lock: lock,
            parent: self,
            index: 2,
            setLatestValue: { (e: E3) in self.latestElement3 = e },
            this: subscription3
        )
...
final class CombineLatest3<E1, E2, E3, Result>: Producer<Result> {
    ...
    init(
        source1: Observable<E1>,
        source2: Observable<E2>,
        source3: Observable<E3>,
...
final class CombineLatestSink4_<E1, E2, E3, E4, Observer: ObserverType>: CombineLatestSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer4 = CombineLatestObserver(
            lock: lock,
            parent: self,
            index: 3,
            setLatestValue: { (e: E4) in self.latestElement4 = e },
            this: subscription4
        )
...
public extension ObservableType {
    ...
    -> Observable<Element> {
        return CombineLatest5(
            source1: source1.asObservable(), source2: source2.asObservable(), source3: source3.asObservable(),
            source4: source4.asObservable(), source5: source5.asObservable(),
            resultSelector: resultSelector
        )
    }
}
...
final class CombineLatestSink5_<E1, E2, E3, E4, E5, Observer: ObserverType>: CombineLatestSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer5 = CombineLatestObserver(
            lock: lock,
            parent: self,
            index: 4,
            setLatestValue: { (e: E5) in self.latestElement5 = e },
            this: subscription5
        )
...
public extension ObservableType {
    ...
    -> Observable<Element> {
        return CombineLatest6(
            source1: source1.asObservable(), source2: source2.asObservable(), source3: source3.asObservable(),
            source4: source4.asObservable(), source5: source5.asObservable(), source6: source6.asObservable(),
            resultSelector: resultSelector
        )
    }
}
...
final class CombineLatestSink6_<E1, E2, E3, E4, E5, E6, Observer: ObserverType>: CombineLatestSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer6 = CombineLatestObserver(
            ...
            parent: self,
            index: 5,
            setLatestValue: { (e: E6) in self.latestElement6 = e },
            this: subscription6
        )
...
final class CombineLatestSink7_<E1, E2, E3, E4, E5, E6, E7, Observer: ObserverType>: CombineLatestSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer7 = CombineLatestObserver(
            ...
            parent: self,
            index: 6,
            setLatestValue: { (e: E7) in self.latestElement7 = e },
            this: subscription7
        )
...
public extension ObservableType {
    ...
    -> Observable<Element> {
        return CombineLatest8(
            source1: source1.asObservable(), source2: source2.asObservable(), source3: source3.asObservable(),
            source4: source4.asObservable(), source5: source5.asObservable(), source6: source6.asObservable(),
            source7: source7.asObservable(), source8: source8.asObservable(),
            resultSelector: resultSelector
        )
    }
}
...
final class CombineLatestSink8_<E1, E2, E3, E4, E5, E6, E7, E8, Observer: ObserverType>: CombineLatestSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer8 = CombineLatestObserver(
            lock: lock,
            parent: self,
            index: 7,
            setLatestValue: { (e: E8) in self.latestElement8 = e },
            this: subscription8
        )
