...
struct Queue<T>: Sequence {
    ...
    init(capacity: Int) {
        ...
        self.storage = ContiguousArray<T?>(repeating: nil, count: capacity)
    }
    ...
    private mutating func resizeTo(_ size: Int) {
        ...
        newStorage[countElementsInFirstBatch..<(countElementsInFirstBatch + numberOfElementsInSecondBatch)] =
            storage[0..<numberOfElementsInSecondBatch]
