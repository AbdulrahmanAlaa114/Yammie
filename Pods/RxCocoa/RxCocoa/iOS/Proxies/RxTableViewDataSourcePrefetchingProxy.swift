    ...
    DelegateProxyType
{
    ...
    private weak var _requiredMethodsPrefetchDataSource: UITableViewDataSourcePrefetching? =
        tableViewPrefetchDataSourceNotSet

    /// For more information take a look at `DelegateProxyType`.
    override open func setForwardToDelegate(
        _ forwardToDelegate: UITableViewDataSourcePrefetching?,
        retainDelegate: Bool
    ) {
...
extension RxTableViewDataSourcePrefetchingProxy: UITableViewDataSourcePrefetching {
    ...
    public func tableView(_ tableView: UITableView, prefetchRowsAt indexPaths: [IndexPath]) {
        ...
        (_requiredMethodsPrefetchDataSource ?? tableViewPrefetchDataSourceNotSet).tableView(
            tableView,
