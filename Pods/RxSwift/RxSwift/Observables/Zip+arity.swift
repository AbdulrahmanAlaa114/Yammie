...
final class ZipSink2_<E1, E2, Observer: ObserverType>: ZipSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer1 = ZipObserver(
            ...
            parent: self,
            index: 0,
            setNextValue: { self.values1.enqueue($0) },
            this: subscription1
        )
        let observer2 = ZipObserver(
            lock: lock,
            parent: self,
            index: 1,
            setNextValue: { self.values2.enqueue($0) },
            this: subscription2
        )
...
final class ZipSink3_<E1, E2, E3, Observer: ObserverType>: ZipSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer3 = ZipObserver(
            lock: lock,
            parent: self,
            index: 2,
            setNextValue: { self.values3.enqueue($0) },
            this: subscription3
        )
...
final class ZipSink4_<E1, E2, E3, E4, Observer: ObserverType>: ZipSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer4 = ZipObserver(
            lock: lock,
            parent: self,
            index: 3,
            setNextValue: { self.values4.enqueue($0) },
            this: subscription4
        )
...
final class ZipSink5_<E1, E2, E3, E4, E5, Observer: ObserverType>: ZipSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer5 = ZipObserver(
            lock: lock,
            parent: self,
            index: 4,
            setNextValue: { self.values5.enqueue($0) },
            this: subscription5
        )
...
final class ZipSink6_<E1, E2, E3, E4, E5, E6, Observer: ObserverType>: ZipSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer6 = ZipObserver(
            lock: lock,
            parent: self,
            index: 5,
            setNextValue: { self.values6.enqueue($0) },
            this: subscription6
        )
...
final class ZipSink7_<E1, E2, E3, E4, E5, E6, E7, Observer: ObserverType>: ZipSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer7 = ZipObserver(
            lock: lock,
            parent: self,
            index: 6,
            setNextValue: { self.values7.enqueue($0) },
            this: subscription7
        )
...
final class ZipSink8_<E1, E2, E3, E4, E5, E6, E7, E8, Observer: ObserverType>: ZipSink<Observer> {
    ...
    func run() -> Disposable {
        ...
        let observer8 = ZipObserver(
            lock: lock,
            parent: self,
            index: 7,
            setNextValue: { self.values8.enqueue($0) },
            this: subscription8
        )
