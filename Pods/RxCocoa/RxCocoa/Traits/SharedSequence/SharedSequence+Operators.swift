...
public extension SharedSequenceConvertibleType {
     ...
     */
    func distinctUntilChanged<Key: Equatable>(_ keySelector: @escaping (Element) -> Key)
    -> SharedSequence<SharingStrategy, Element> {
        let source = asObservable()
     ...
     */
    func distinctUntilChanged(_ comparer: @escaping (Element, Element) -> Bool)
    -> SharedSequence<SharingStrategy, Element> {
        let source = asObservable()
    ...
    func distinctUntilChanged<K>(
        _ keySelector: @escaping (Element) -> K,
...
public extension SharedSequenceConvertibleType {
    ...
    func flatMap<
        Sharing,
        Result
    >(_ selector: @escaping (Element) -> SharedSequence<Sharing, Result>) -> SharedSequence<Sharing, Result> {
        let source = asObservable()
            .flatMap(selector)
...
public extension SharedSequenceConvertibleType {
    ...
    /**
     ...
     - returns: The observable sequence that merges the elements of the observable sequences.
     */
    static func merge(_ sources: [SharedSequence<SharingStrategy, Element>])
    -> SharedSequence<SharingStrategy, Element> {
        let source = Observable.merge(sources.map { $0.asObservable() })
        return SharedSequence<SharingStrategy, Element>(source)
    }
...
public extension SharedSequence {
    ...
    /**
     ...
     - returns: An observable sequence that contains the elements of each given sequence, in sequential order.
     */
    static func concat<Collection: Swift.Collection>(_ collection: Collection)
        -> SharedSequence<SharingStrategy, Element>
        where Collection.Element == SharedSequence<SharingStrategy, Element>
    {
...
public extension SharedSequence {
    ...
    where Collection.Element == SharedSequence<SharingStrategy, Element> {
        let source = Observable.zip(
            collection.map { $0.asSharedSequence().asObservable() },
     ...
     */
    static func zip<Collection: Swift.Collection>(_ collection: Collection)
        -> SharedSequence<SharingStrategy, [Element]>
        where Collection.Element == SharedSequence<SharingStrategy, Element>
    {
...
public extension SharedSequence {
    /**
     ...
     - returns: An observable sequence containing the result of combining elements of the sources using the specified result selector function.
     */
    static func combineLatest<Collection: Swift.Collection, Result>(
        _ collection: Collection,
        resultSelector: @escaping ([Element]) throws -> Result
    ) -> SharedSequence<SharingStrategy, Result>
    where Collection.Element == SharedSequence<SharingStrategy, Element> {
    ...
    /**
     ...
     - returns: An observable sequence containing the result of combining elements of the sources.
     */
    static func combineLatest<Collection: Swift.Collection>(_ collection: Collection)
        -> SharedSequence<SharingStrategy, [Element]>
        where Collection.Element == SharedSequence<SharingStrategy, Element>
    {
...
public extension SharedSequenceConvertibleType where SharingStrategy == DriverSharingStrategy {
    @available(
        *,
        message: "withUnretained has been deprecated for Driver. Consider using `drive(with:onNext:onCompleted:onDisposed:)`, instead",
        unavailable
    )
    func withUnretained<Object: AnyObject, Out>(
        _ obj: Object,
...
public extension SharedSequenceConvertibleType {
     ...
     */
    func withLatestFrom<SecondO: SharedSequenceConvertibleType, ResultType>(
        _ second: SecondO,
        resultSelector: @escaping (Element, SecondO.Element) -> ResultType
    ) -> SharedSequence<SharingStrategy, ResultType> where SecondO.SharingStrategy == SharingStrategy {
        let source = asObservable()
    ...
    /**
     ...
     - returns: An observable sequence containing the result of combining each element of the self  with the latest element from the second source, if any, using the specified result selector function.
     */
    func withLatestFrom<SecondO: SharedSequenceConvertibleType>(_ second: SecondO)
    -> SharedSequence<SharingStrategy, SecondO.Element> {
        let source = asObservable()
